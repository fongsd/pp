...
{
       0,    96,    96,    97,    99,   104,   108,   118,   119,   128,
     135,   142,   149,   153,   158,   159,   171,   175
};
#endif
...
{
  "$end", "error", "$undefined", "DODELA_T", "PRINT_T", "UGAO_T", "EQV_T",
  "ID_T", "BROJ_T", "'-'", "'+'", "'*'", "';'", "'('", "')'", "','", "'.'",
...
static const yytype_uint16 yytoknum[] =
{
      ...
      43,    42,    59,    40,    41,    44,    46,   124,    60,    62
};
# endif
...
{
      -3,     0,    10,    17,    30,    40,     4,    34,    21,    37,
      27,    -7,     4,     4,     4,     4,     4,    -7,     7,    -7,
      42,    -7,    47,    -7,     4,     4,     4,    38,    31,    35,
      22,    -7,    -7,    54,    -7,    -7,    -7,    -7,    22,    -7,
       4,     4,    -7,    44,    46,    -7,    -7
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,    13,     0,     0,     0,     0,     0,    15,     0,    17,
       0,     1,     0,     3,     0,     0,     0,     0,     0,     0,
       4,    12,     9,     0,    14,     2,    11,    10,     8,     5,
       0,     0,    16,     0,     0,     6,     7
};
...
{
      18,     1,     2,     3,     4,     5,    27,    28,    29,    30,
      31,    17,     5,    12,     6,     7,    24,    25,    36,    37,
      38,    21,     7,    13,    32,     1,     2,     3,     4,     5,
      14,    24,    25,    15,    43,    44,    24,    25,     6,     7,
      24,    25,    19,    26,    24,    25,    40,    24,    25,    23,
      41,    16,    39,    24,    25,    24,    25,    33,    45,    35,
      46,    34,    42,    22
};

static const yytype_uint8 yycheck[] =
{
       6,     4,     5,     6,     7,     8,    12,    13,    14,    15,
      16,     7,     8,    13,    17,    18,     9,    10,    24,    25,
      26,     0,    18,    13,    17,     4,     5,     6,     7,     8,
      13,     9,    10,     3,    40,    41,     9,    10,    17,    18,
       9,    10,     8,    16,     9,    10,    15,     9,    10,    12,
      15,    11,    14,     9,    10,     9,    10,    15,    14,    12,
      14,    19,     8,     8
};
...
{
       0,     4,     5,     6,     7,     8,    17,    18,    21,    22,
      23,    24,    13,    13,    13,     3,    11,     7,    23,     8,
      25,     0,    22,    12,     9,    10,    16,    23,    23,    23,
      23,    23,    17,    15,    19,    12,    23,    23,    23,    14,
      15,    15,     8,    23,    23,    14,    14
};
...
#line 99 "parser.ypp" /* yacc.c:1646  */
    {
                                                    vars[*(yyvsp[-2].ime)] = new std::vector<double>(*(yyvsp[0].el));
                                                    delete (yyvsp[-2].ime);
                                                    delete (yyvsp[0].el);
                                                }
...
#line 108 "parser.ypp" /* yacc.c:1646  */
    {
                                                    if(!check_dim((yyvsp[-3].el), (yyvsp[-1].el)))
                                                      yyerror("greska u dimenzionalnosti vektora");
                                                   
                                                        double ug = izracunaj_ugao((yyvsp[-3].el), (yyvsp[-1].el));
                                                        printf("%g\n", ug * 360 / (2 * M_PI));
...
#line 119 "parser.ypp" /* yacc.c:1646  */
    {
                                                    if(!check_dim((yyvsp[-2].el), (yyvsp[0].el)))
                                                        yyerror("greska u dimenzionalnosti vektora");
                                                    double sp = skalarni_proizvod((yyvsp[-2].el), (yyvsp[0].el));
                                                    printf("%g\n", sp);
...
#line 135 "parser.ypp" /* yacc.c:1646  */
    {
                                                    if(!check_dim((yyvsp[-2].el), (yyvsp[0].el)))
                                                        yyerror("greska u dimenzionalnosti vektora");
                                                    (yyval.el) = saberi((yyvsp[-2].el), (yyvsp[0].el));
                                                    delete (yyvsp[-2].el);
                                                    delete (yyvsp[0].el);
                                                }
...
#line 142 "parser.ypp" /* yacc.c:1646  */
    {
                                                    if(!check_dim((yyvsp[-2].el), (yyvsp[0].el)))
                                                        yyerror("greska u dimenzionalnosti vektora");
                                                    (yyval.el) = oduzmi((yyvsp[-2].el), (yyvsp[0].el));
                                                    delete (yyvsp[-2].el);
                                                    delete (yyvsp[0].el);
                                                }
...
#line 149 "parser.ypp" /* yacc.c:1646  */
    {
                                                    (yyval.el) = pomnozi_skalarom((yyvsp[0].el), (yyvsp[-2].vrednost));
                                                    delete (yyvsp[0].el);
                                                }
...
#line 159 "parser.ypp" /* yacc.c:1646  */
    {
                                                    ...
                                                    if(it == vars.end()){
                                                        yyerror("Promenljiva " + (*(yyvsp[0].ime)) + " nije definisana");
                                                    }
                                                    else {
                                                        (yyval.el) = new std::vector<double>( *(it->second) );
                                                    }
                                                    delete (yyvsp[0].ime);
...
#line 175 "parser.ypp" /* yacc.c:1646  */
    {
                                                    (yyval.el) = new std::vector<double>(1, (yyvsp[0].vrednost));
                                                }
